...
HD_PWD='D:/Banan/ITMO/3/shemotehnika/test4/test4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log main_sum_tests.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source main_sum_tests.tcl
